    ...
    <div className="p-1 bg-white flex justify-between items-center sm:space-x-5 shadow-md w-[100vw]">
      ...
      <div className="Center flex-1 justify-center flex">
        <div className='space-x-5 bg-[#ecf0f1] w-fit py-1 sm:px-5 rounded-lg sm:max-w-[60%] sm:flex-1 px-2 justify-around flex'>
          <HomeRoundedIcon className="Icon sm:hover:bg-white md:flex-[0.2] rounded-lg" />
          <PeopleAltRoundedIcon className="Icon sm:hover:bg-white md:flex-[0.2] rounded-lg" />
          <OndemandVideoRoundedIcon className="Icon sm:hover:bg-white md:flex-[0.2] rounded-lg" />
          <DeviceHubIcon className="Icon sm:hover:bg-white md:flex-[0.2] rounded-lg sm:hidden"/>
          <CircleNotificationsIcon className="Icon sm:hover:bg-white md:flex-[0.2] rounded-lg sm:hidden"/>
        </div>
      </div>
