    ...
    <div>
      {props ? (
        <div className="flex space-x-3 items-center bg-white p-3 rounded-sm shadow-md">
          ...
          <div className="Name-Control space-y-1">
            ...
            <div className="Control text-white space-x-2">
              ...
              <button className="bg-[#e74c3c] p-1 rounded-sm text-xs text-black">
                Decline
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center items-center space-y-5">
          ...
          <p className="text-gray-500 text-center ">No Available Request <SentimentVeryDissatisfiedIcon className="text-blue-500"/>. Search People to Make Friends or Send Friend Requests </p>
        </div>
      )}
    </div>
  );
